    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="input-large"><?php echo $dados['RiscoExterno']['codigo_externo'] ?></td>
                <td>    
                    <?php if($dados['Risco']['ativo']== 0): ?>
                        <span class="badge-empty badge badge-important" title="Desativado"></span>
                    <?php elseif($dados['Risco']['ativo']== 1): ?>
                        <span class="badge-empty badge badge-success" title="Ativo"></span>
                    <?php endif; ?>
                
                    <?php echo $this->Html->link('', array('action' => 'editar_externo',  $codigo_cliente_filtro, $dados['Risco']['codigo'], $dados['RiscoExterno']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar Código Externo')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
