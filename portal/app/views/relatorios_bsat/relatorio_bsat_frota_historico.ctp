...
<div class='well'>
    ...
    <span class="pull-right">
		<?php echo $this->Html->link('<i class="cus-page-white-excel"></i>', 'javascript:void(0)', array('escape' => false, 'title' =>'Exportar para Excel', 'onclick' => "exportar_relatorio_historico('{$this->data['RelatorioBsat']['codigo_pedido']}', 'frota')"));?>
	</span>
</div>
