...
<?php
		...
		header(sprintf('Content-Disposition: attachment; filename="%s"', basename('relatorio_frota.csv')));
    	header('Pragma: no-cache');
   		echo iconv('UTF-8', 'ISO-8859-1', '"Item";"Placa";"Valor dos Servicos"')."\n";
...
<div class='well'>
    ...
    <span class="pull-right">
		<?php echo $this->Html->link('<i class="cus-page-white-excel"></i>', 'javascript:void(0)', array('escape' => false, 'title' =>'Exportar para Excel', 'onclick' => "exportar_relatorio('{$this->data['RelatorioBsat']['data_inicial']}', '{$this->data['RelatorioBsat']['data_final']}', '{$this->data['RelatorioBsat']['codigo_cliente']}', 'frota')"));?>
	</span>
</div>
