    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="input-large"><?php echo $dados['CargoExterno']['codigo_externo'] ?></td>
                <td>    
                    ...
                    <?php echo $this->Html->link('', array('action' => 'editar_externo',  $codigo_cliente_filtro, $dados['Cargo']['codigo'], $dados['CargoExterno']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar Código Externo')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
