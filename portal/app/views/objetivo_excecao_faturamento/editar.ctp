<?php echo $this->BForm->create('ObjetivoExcecaoFaturamento', array('type' => 'post' ,'url' => array('controller' => 'objetivo_excecao_faturamento','action' => 'editar',$this->data['ObjetivoExcecaoFaturamento']['codigo'])));?>
