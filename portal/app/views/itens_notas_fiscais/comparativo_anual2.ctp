...
<?php endif; ?>
<div class='well'>
	<?php echo $this->BForm->create('Notaite', array('url' => array('controller' => 'itens_notas_fiscais', 'action' => 'comparativo_anual2'))); ?>
	<?php echo $this->element('itens_notas_fiscais/fields_filtros'); ?>
