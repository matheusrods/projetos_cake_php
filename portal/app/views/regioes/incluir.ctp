<?php echo $this->BForm->create('TRegiRegiao', array('url' => array('controller' => 'Regioes','action' => 'incluir',$cliente['Cliente']['codigo'])));?>
	...
	<?php echo $this->BForm->hidden('regi_pjur_pess_oras_codigo',array('value' => $cliente_pjur['TPjurPessoaJuridica']['pjur_pess_oras_codigo'])) ?>
