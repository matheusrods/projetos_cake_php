<?php if(!empty($aparelhos)):?>
    ...
    <table class="table table-striped">
        <thead>
            ...
            <th class="input-xxlarge">Fabricante</th>
        ...
        <tbody>
            ...
            <tr>
                <td class="input-mini"><?php echo $dados['AparelhoAudiometrico']['codigo'] ?></td>
                <td class="input-xxlarge"><?php echo $dados['AparelhoAudiometrico']['descricao'] ?></td>
                <td class="input-xxlarge"><?php echo $dados['AparelhoAudiometrico']['fabricante'] ?></td>
                <td>
                ...
                <?php echo $this->Html->link('', array('action' => 'editar', $dados['AparelhoAudiometrico']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
...
echo $this->Javascript->codeBlock("
    ...
    function atualizaStatus(codigo, status){
        $.ajax({
            type: 'POST',
            url: baseUrl + 'aparelhos_audiometricos/atualiza_status/' + codigo + '/' + status + '/' + Math.random(),
            beforeSend: function(){
