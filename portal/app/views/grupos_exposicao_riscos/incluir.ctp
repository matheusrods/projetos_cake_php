<?php echo $this->BForm->create('GrupoExposicaoRisco', array('url' => array('controller' => 'grupos_exposicao_riscos','action' => 'incluir', $codigo_cliente, $codigo_grupo_exposicao))); ?>
<?php echo $this->element('grupos_exposicao_riscos/fields', array('edit_mode' => false)); ?>
...
<div style="display:none;">
    ...
    <tr class="linhas" id="modelo_epc">
        ...
        <td><?php echo $this->BForm->input('GrupoExposicaoRiscoEpc.x.controle_epc', array('label' => false, 'class' => 'input-medium controle_epc','options' => array('E' => 'Existente', 'R' => 'Recomendado'), 'empty' => 'Selecione')); ?></td>
