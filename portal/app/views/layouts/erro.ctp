...
<html lang="pt">
  <head>
    ...
    <meta name="resource-type" content="document" />	
		...
		<meta name="description" content="Controle de Estoque Online" />
		<meta name="keywords" content="controle,empresa,controle estoque,controle de estoque,controle financeiro,fluxo caixa,fluxo de caixa" />
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <?php if(stripos(Router::url( $this->here, true ), 'sgibr') == true): ?>
            <?php echo $this->Html->link($this->Html->image('/img/sgi-menu.png'), array('controller'=>'usuarios', 'action'=>'inicio'), array('escape' => false, 'class' => 'brand')); ?>
          <?php else: ?>
            <a class="brand" href="#">.:IT Health</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
