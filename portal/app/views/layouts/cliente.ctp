...
<html lang="pt">
    <head>
        ...
        <?php //echo $this->Buonny->link_css('alertas'); ?>
    ...
    <body>
        ...
        <?php echo $this->element('modulos_terceiros'); ?>
        ...
        <?php //echo $this->Buonny->link_js('superfish'); ?>
        <?php //echo $this->Buonny->link_js('alertas') ?>
