    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="pagination-centered">
                	<?php echo $html->link('', array('controller' => 'funcionarios', 'action' => 'index', $cliente['Cliente']['codigo'], 'principal', 'ppp'), array('class' => 'icon-wrench', 'title' => 'Funcionários do Cliente')); ?>
            </td>
        </tr>
        <?php endforeach; ?>        
    </tbody>
