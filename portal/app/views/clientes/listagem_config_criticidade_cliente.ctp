...
<?php if (!empty($pos_criticidade)):?>
    ...
    <table class="table table-striped">
        ...
        <tbody>
        <?php foreach($pos_criticidade as $cliente) :?>
            <tr>
                <td class="input-mini"><?= $cliente["PosCriticidade"]["codigo"] ?></td>
                <td><?= $cliente["PosFerramenta"]["descricao"] ?></td>
                <td><?= $cliente["PosCriticidade"]["descricao"] ?></td>
                <td style="text-align: center">
                    <?php echo $this->Html->link('', array('controller' => 'clientes', 'action' => 'editar_config_criticidade', $cliente["PosCriticidade"]["codigo_cliente"], $cliente["PosCriticidade"]["codigo_pos_ferramenta"]), array('class' => 'icon-cog', 'title' => 'Visualizar'));?>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
...
<?php endif;?>
<div class="well">
    <?php echo $html->link('Voltar', array('action' => 'config_criticidade'), array('class' => 'btn')); ?>
</div>
<?php
