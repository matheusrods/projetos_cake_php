...
<?php if ($codigo_status_importacao == StatusImportacao::SEM_PROCESSAR): ?>
	<span class='alerta inclusao'>Campos em verde serão incluídos</span> <span class='alerta alteracao'>Campos em azul serão atualizados</span> <span class='icon-warning-sign'></span> Alerta de inconsistência
<?php endif ?>
