<div>
	...
	<div class='row-fluid inline'>
		...
		<?php echo $this->BForm->input('codigo_veiculo_classificacao', array('label' => 'Tipo de Evento', 'class' => 'input-xlarge', 'options' => $classificacoes, 'empty' => 'Selecione a classificação')); ?>
	</div>
