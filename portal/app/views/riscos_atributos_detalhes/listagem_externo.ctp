<?php if(!empty($riscos_atributos_detalhes)):?>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <?php foreach ($riscos_atributos_detalhes as $dados): ?>
            <tr>
                ...
                <td class="input-large"><?php echo $dados['RiscoAtributoDetalheExterno']['codigo_externo'] ?></td>
                <td>    
                    ...
                    <?php echo $this->Html->link('', array('action' => 'editar_externo',  $codigo_cliente_filtro, $dados['RiscoAtributoDetalhe']['codigo'], $dados['RiscoAtributoDetalheExterno']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar Código Externo')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
...
echo $this->Javascript->codeBlock("
    ...
    bloquearDiv(div);
    div.load(baseUrl + 'grupos_riscos/listagem_externo/' + Math.random());
}
