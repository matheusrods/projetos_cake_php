<div class="row-fluid inline">
    ...
    if($this->Buonny->seUsuarioForMulticliente()) { 
        echo $this->Buonny->input_codigo_cliente($this, 'codigo_cliente', 'Cliente', null, 'TecnicaMedicaoPpra'); 
    }
    else{
        echo $this->Buonny->input_codigo_cliente($this, 'codigo_cliente', 'Cliente', 'Cliente', 'TecnicaMedicaoPpra', isset($codigo_cliente) ? $codigo_cliente : '');
    }
