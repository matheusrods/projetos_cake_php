...
<div class='well'>
    ...
    <div class="row-fluid inline">
        ...
        <?php echo $this->BForm->input('codigo_pos_ferramenta', array('id' => 'pos_ferramenta', 'label' => 'Tipo da ferramenta (*)','class' => 'input-medium', 'options'=> $combo_pos_ferramenta, 'empty' => 'Selecione', 'default' => 1)); ?>
    </div>
    ...
    <div class="row-fluid inline criticidade1">
        ...
        <?php echo $this->BForm->input('PosCriticidade[][0][cor]', array('class' => 'input-mini jscolor', 'placeholder' => 'Cor', 'label' => 'Cor (*)' )) ?>
        <?php echo $this->BForm->input('PosCriticidade[][0][valor_inicio]', array('class' => 'input-mini numeric valor_inicio', 'label' => 'De')) ?>
        <?php echo $this->BForm->input('PosCriticidade[][0][valor_fim]', array('class' => 'input-mini numeric valor_fim', 'label' => 'Até')) ?>
    </div>
    ...
    <div class="row-fluid inline criticidade2">
        ...
        <?php echo $this->BForm->input('PosCriticidade[][1][cor]', array('class' => 'input-mini jscolor', 'placeholder' => 'Cor', 'label' => 'Cor (*)')) ?>
        <?php echo $this->BForm->input('PosCriticidade[][1][valor_inicio]', array('class' => 'input-mini numeric valor_inicio', 'label' => 'De')) ?>
        <?php echo $this->BForm->input('PosCriticidade[][1][valor_fim]', array('class' => 'input-mini numeric valor_fim', 'label' => 'Até')) ?>
    </div>
    ...
    <div class="row-fluid inline criticidade3">
        ...
        <?php echo $this->BForm->input('PosCriticidade[][2][cor]', array('class' => 'input-mini jscolor', 'placeholder' => 'Cor', 'label' => 'Cor (*)')) ?>
        <?php echo $this->BForm->input('PosCriticidade[][2][valor_inicio]', array('class' => 'input-mini numeric valor_inicio', 'label' => 'De')) ?>
        <?php echo $this->BForm->input('PosCriticidade[][2][valor_fim]', array('class' => 'input-mini numeric valor_fim', 'label' => 'Até')) ?>
    </div>
    ...
    <div class="row-fluid inline criticidade4">
        ...
        <?php echo $this->BForm->input('PosCriticidade[][3][cor]', array('class' => 'input-mini jscolor', 'placeholder' => 'Cor', 'label' => 'Cor (*)')) ?>
        <?php echo $this->BForm->input('PosCriticidade[][3][valor_inicio]', array('class' => 'input-mini numeric valor_inicio', 'label' => 'De')) ?>
        <?php echo $this->BForm->input('PosCriticidade[][3][valor_fim]', array('class' => 'input-mini numeric valor_fim', 'label' => 'Até')) ?>
    </div>
...
<div id="salvarCriticidade" class="btn btn-primary">Salvar</div>
...
<script>
    $(function(){
        ...
        //Salvar criticidade
        $("#salvarCriticidade").on("click", function(e){
            e.preventDefault();

            var codigo_pos_ferramenta = $("#pos_ferramenta").val();

            $("#salvarCriticidade").attr("disabled", "disabled")

            $.ajax({
                url: baseUrl + 'clientes/verificar_criticidade/<?= $codigo_cliente?>/'+ codigo_pos_ferramenta +'',
                type: 'GET',
                dataType: 'html',
                success: function(data){
                    ...
                    if (data == 1) {
                        ...
                        $("#ClienteIncluirConfigCriticidadeForm").submit();

                    } else {
                        alert("Este cliente já possui uma configuração para esse tipo de ferramenta.\nVá para editar configuração de criticidade.")
                        $("#salvarCriticidade").removeAttr("disabled")
                    }
