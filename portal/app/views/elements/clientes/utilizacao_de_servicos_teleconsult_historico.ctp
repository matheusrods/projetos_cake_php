        ...
        <tbody>
            ...
            <?php if ($utilizacoes_tlc): ?>
                <?php foreach($utilizacoes_tlc as $utilizacao): ?>
                    ...
                    <tr>
                        <td><?= $this->Html->link($utilizacao['0']['codigo_cliente_pagador'], "javascript:utilizacao_de_servicos_tlc_filhos('{$utilizacao['0']['codigo_cliente_pagador']}', '{$this->data['Cliente']['data_inicial']}', '{$this->data['Cliente']['data_final']}')") ?></td>
