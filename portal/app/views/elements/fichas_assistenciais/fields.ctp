	...
	<div class="bordered">
		...
		<div class="row-fluid">
			...
			<?php else: ?>
				...
				<?php echo $this->BForm->hidden('hora_fim_atendimento', array('value' => '')); ?>
			<?php endif; ?>
		</div>
		<hr>
		<div class="bordered">
		...
		<div class="bordered" <?=$gestacional_preventivos?>>
			<div class='row-fluid inline'>	
				...
				<div class="accordion" id="accordion2">
					...
					<!-- MONTA AS QUESTOES -->
					<?php 
					foreach ($grupoQuestao['FichaAssistencialQuestao'] as $key2 => $questao) {
								...
								<div class="checkbox-canvas if-booleano">
									...
									switch ($questao['tipo']) {
										...
										case 'RADIO':
											...
											// cria o input
											echo $this->BForm->input('FichaAssistencialResposta.'.$questao['codigo'].'_resposta', array('type' => 'radio', 	
											...
											if(!empty($questao['parentesco_ativo'])) {
												echo $this->BForm->input('FichaAssistencialResposta.parentesco.'.$questao['codigo'], array( 'options' => array('Pai' => 'Pai', 'Mãe' => 'Mãe', 'Irmãos'=> 'Irmãos'), 'empty' => 'Parentesco', 'class' => 'adjust-parentesco hide', 'div' => false, 'label' => false));
									...
									<div class="checkbox-canvas if-booleano">
										...
										switch ($subquestao['tipo']) {
											...
											case 'RADIO':
												...
												// cria o input
												echo $this->BForm->input('FichaAssistencialResposta.'.$subquestao['codigo'].'_resposta', array('type' => 'radio', 'options' => (array)json_decode($subquestao['conteudo']), 'default' => $default, 'data-open' => $openMenu, 'hiddenField' => false, 'legend' => false, 'required' => $required, 'suboption' => 1, 'data-option' => $subquestao['opcao_exibe_label']));

												// cria o campo livre caso exista
												if(!empty($subquestao['parentesco_ativo'])) {
													echo $this->BForm->input('FichaAssistencialResposta.parentesco.'.$subquestao['codigo'], array( 'options' => array('Pai' => 'Pai', 'Mãe' => 'Mãe', 'Irmãos' => 'Irmãos'), 'default' => $default, 'empty' => 'Parentesco', 'class' => 'adjust-parentesco hide', 'div' => false, 'label' => false));
												} elseif(!empty($subquestao['campo_livre_label'])) {
													echo $this->BForm->input('FichaAssistencialResposta.campo_livre.'.$subquestao['codigo'], array('style' => 'width: 95%', 'label' => false, 'placeholder' => $subquestao['campo_livre_label'], 'style' => 'margin-bottom: 0; margin-left:10px; margin-top: -6px;', 'div' => 'js-label '.((!empty($subquestao['opcao_exibe_label']))? 'hide' : '')));
												}
											break;
								...
								<div class="js-encapsulado">
									...
									<div class="inputs-config span12 hide" style="margin-left: 0; margin-right: 1%">
										<div class="checkbox-canvas">
											...
											<div class="row-fluid pull-left padding-left-10 margin-top-5">
												<div class="span4">
													<?php echo $this->BForm->input('FichaAssistencialResposta.cid10.'.$questao['codigo'].'.0.farmaco', array('label' => false, 'placeholder' => 'Fármaco', 'class' => 'js-farmaco', 'div' => array('style' => 'width: 95%'))) ?>
												</div>
												<div class="span4">
													<?php echo $this->BForm->input('FichaAssistencialResposta.cid10.'.$questao['codigo'].'.0.posologia', array('label' => false, 'placeholder' => 'Posologia', 'class' => 'js-posologia', 'div' => array('style' => 'width: 95%'))) ?>
												</div>
												<div class="span4">
													<?php echo $this->BForm->input('FichaAssistencialResposta.cid10.'.$questao['codigo'].'.0.dose_diaria', array('label' => false, 'placeholder' => 'Dose diária', 'div' => array('style' => 'width: 95%'))) ?>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="div-oculta hide">
										<div class="row-fluid pull-left padding-left-10 margin-top-5">
											...
											<?php
												...
												if(isset($dados_atestado['habilita_afastamento_em_horas']) && $dados_atestado['habilita_afastamento_em_horas'] == 1){
													...
													if(!empty($this->data['FichaAssistencial']['AtestadoMedico']['habilita_afastamento_em_horas'])){
										...
										<div class="row-fluid pull-left padding-left-10 margin-top-5">	
											...
											<?php 
												...
												$data_afastamento_periodo = date('d/m/Y');

												if(isset($dados_atestado['data_afastamento_periodo']) && !empty($dados_atestado['data_afastamento_periodo'])){
													$data_afastamento_periodo = $dados_atestado['data_afastamento_periodo'];
												}
											...
											<div class="span3">
												<?php echo $this->BForm->input('FichaAssistencial.AtestadoMedico.data_afastamento_periodo', 
													array('label' => false, 
													'value' => $data_afastamento_periodo, 
													'before' => 'De: ', 
											...
											<div class="span3">
												<?php 
													...
													if(isset($dados_atestado['data_retorno_periodo']) && !empty($dados_atestado['data_retorno_periodo'])){
														...
														$data_retorno_periodo = $dados_atestado['data_retorno_periodo'];
													}
												?>
											...
											<div class="span3">
												<?php 
													...
													if(isset($dados_atestado['afastamento_em_dias']) && !empty($dados_atestado['afastamento_em_dias'])){
														...
														$afastamento_em_dias = $dados_atestado['afastamento_em_dias'];
													}
												?>
											...
											<div class="span3">
												<?php 
													...
													if(isset($dados_atestado['hora_afastamento']) && !empty($dados_atestado['hora_afastamento'])){
														...
														$hora_afastamento = $dados_atestado['hora_afastamento'];
													}
												?>
											...
											<div class="span3">
												<?php 
													...
													if(isset($dados_atestado['hora_retorno']) && !empty($dados_atestado['hora_retorno'])){
														...
														$hora_retorno = $dados_atestado['hora_retorno'];
													}
												?>
										...
										<div class="row-fluid pull-left padding-left-10 margin-top-5">
											<?php 
												...
												if(isset($dados_atestado['codigo_motivo_licenca']) && !empty($dados_atestado['codigo_motivo_licenca'])){
													...
													$motivo = $dados_atestado['codigo_motivo_licenca'];
												}
											?>
										...
										<div class="row-fluid pull-left padding-left-10 margin-top-5">
											...
											<?php 
												...
												if(isset($dados_atestado['codigo_motivo_esocial']) && !empty($dados_atestado['codigo_motivo_esocial'])){
													$esocial = $dados_atestado['codigo_motivo_esocial'];
												}
											?>
										...
										<div class="row-fluid pull-left padding-left-10 margin-top-5">
											<?php 
												...
												if(isset($dados_atestado['restricao']) && !empty($dados_atestado['restricao'])){
													$restricao = $dados_atestado['restricao'];
												}
											?>
...
<script type="text/javascript">
	$(document).ready(function() {
        ...
        jQuery("input[type='submit']").on('click', function(e){
            ...
            jQuery(this).prop("value", "Carregando, Aguarde..");
        });
			...
			if(this_attr.attr('data-open')) {
				...
				if(!isNaN(parseInt(this_attr.val())) &&  this_attr.attr('suboption') != 1) {	
					if(parseInt(this_attr.val()) > 0) {
						this_attr.parents('.if-booleano').find('.adjust-parentesco').removeClass('hide');
						this_attr.parents('.subgroup-question').find('.inputs-config.hides').show();
						this_attr.parents('.if-booleano').find('.div-oculta').show();
					} else {
						this_attr.parents('.if-booleano').find('.adjust-parentesco').addClass('hide');
		...
		});//FINAL keyup CLASSE js-farmaco E js-farm
	...
	$(document).ready(function() {
		...
		var data_retorno = '<?php echo (!empty($this->data['FichaAssistencial']['AtestadoMedico']['data_retorno_periodo'])? $dados['Atestado']['data_retorno_periodo'] : 0) ?>';
		
		//console.log(typeof(habilita_hora) + ' | ' + habilita_hora);
		//console.log(habilita_hora == '1');
