...
<div class="row-fluid inline">
	<?php echo $this->BForm->input('codigo', array('class' => 'input-medium', 'label' => 'Código Motivos de Licença', 'type' => 'text')) ?>
	...
	<?php echo $this->BForm->input('codigo_externo', array('class' => 'input-small', 'label' => 'Código Externo')); ?>
</div>