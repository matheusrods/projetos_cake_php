...
<?php echo $this->BForm->hidden('codigo', array('value' =>  !empty($this->data['Especialidade']['codigo'])? $this->data['Especialidade']['codigo'] : '')); ?>  
  
 <div class='form-actions'>
	 <?php echo $this->BForm->submit('Salvar', array('div' => false, 'class' => 'btn btn-primary')); ?>
	 <?= $html->link('Voltar', array('controller' => 'especialidades', 'action' => 'index'), array('class' => 'btn')); ?>
</div>