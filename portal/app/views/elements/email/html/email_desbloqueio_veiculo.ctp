...
<p class="titulo">
	COMUNICADO DE DESBLOQUEIO DE VE&Iacute;CULO: <? echo strtoupper($dados['TVeicVeiculo']['veic_placa'])?>
</p>
<p class="corpo">
	Prezados Srs,<br/><br/><br/>
	Informamos  que o ve&iacute;culo abaixo foi desbloqueado.<br/><br/>
	Desta forma, o ve&iacute;culo esta liberado para emiss&atilde;o de Solicita&ccedil;&atilde;o de Monitoramento.
	Em caso de duvidas entrar em contato com a &aacute;rea de Gerenciamento de Riscos.<br/><br/>
</p>
<p class="corpo">
	Usu&aacute;rio que realizou o desbloqueio: <?=$nome_usuario?><br/>
