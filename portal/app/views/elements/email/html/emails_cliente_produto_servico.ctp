...
<?php
if($tipoEmail == 'alteracao_cliente_produto_servico'){
...
}elseif($tipoEmail == 'cadastro_cliente_produto_servico'){
	echo "<strong>Incluído por: </strong>{$log['Usuario']['apelido']}";
}elseif($tipoEmail == 'exclusao_cliente_produto_servico'){
	echo "<strong>Excluído por: </strong>{$log['UsuarioAlteracao']['apelido']}";
}
?>