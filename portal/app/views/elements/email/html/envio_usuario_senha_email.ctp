<table width="500" style="font-family:verdana;">
	...
	<tr>
		<td style="font-size:12px;" colspan="2">Ficamos muito felizes com o seu interesse em se tornar um de nossos parceiros. A partir de agora você já pode acessar o portal RH Health com suas próprias credenciais.<br /><br /></td>
	</tr>
	<tr>
		<td style="font-size:12px; font-weight: bold;" colspan="2"><br />Anote suas informações e acesse o portal para saber mais.<br /><br /></td>
	</tr>	
	<tr>
		<td style="font-size:12px; font-weight: bold;" colspan="2"><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>" target="_blank" style="text-decoration: none; color: black">http://portal.rhhealth.com.br</a></td>
	</tr>
	<tr>
		<td><br /></td>
	</tr>		
