<div class='well'>
	<?php echo $this->Bajax->form('Tranrec', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Tranrec', 'element_name' => 'comissoes_por_corretora_sintetico'), 'divupdate' => '.form-procurar')) ?>
