...
<div class="row-fluid inline">
	...
	<?php echo $this->BForm->input('codigo_cat', array('label' => false,'placeholder' => 'Código Cat', 'class' => 'input-medium ', 'type' => 'text')); ?>
    ...
    <?php echo $this->BForm->input('status_xml', array('label' => false, 'style' => 'margin-left: -50px;', 'class' => 'input-medium','options' => array('D' => 'Disponível para download', 'X' => 'XML com insconsistência'), 'empty' => 'Status')); ?>
</div>