<div id="AnalistasGraph" style="width:98%;height:450px;float:left"></div>
<?php 




if(isset($AnalistasGraph['eixo_x']))
{

  echo $this->Javascript->codeBlock($this->Highcharts->render($AnalistasGraph['eixo_x'], $AnalistasGraph['series'], array(
      'renderTo' => 'AnalistasGraph',
     ...
     // ),
      ...
      'title' => 'Não Entregues por Status',
      'plotOptions' => array(         
          'series' => array(
              //'stacking' => 'normal'
          )
