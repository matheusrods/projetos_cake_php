<div id="horasgraphitems" style="width:48%;height:450px;float:left"></div>
<?php 




if(isset($horasgraphitems['eixo_x']))
{

  echo $this->Javascript->codeBlock($this->Highcharts->render($horasgraphitems['eixo_x'], $horasgraphitems['series'], array(
      'renderTo' => 'horasgraphitems',
     ...
     // ),
      ...
      'title' => 'Horas Estimadas no Período por Analista',
      'plotOptions' => array(         
          'series' => array(
              //'stacking' => 'normal'
          )
