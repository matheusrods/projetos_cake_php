<div class="row-fluid inline">
	<?php echo $this->BForm->input('codigo', array('class' => 'input-mini', 'placeholder' => 'Código', 'label' => false, 'type' => 'text')) ?>
 	...
 	<?php echo $this->BForm->input('codigo_externo', array('class' => 'input-large', 'placeholder' => 'Codigo Externo', 'label' => false)) ?>  
	<?php echo $this->BForm->hidden('codigo_cliente', array('value' => $this->data['Atribuicao']['codigo_cliente'])); ?>
</div>        