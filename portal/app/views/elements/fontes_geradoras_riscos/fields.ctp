 <div class='row-fluid inline'>
	...
	<?php endif;  ?>
	<?php echo $this->BForm->hidden('codigo', array('value' =>  !empty($this->data['FonteGeradora']['codigo'])? $this->data['FonteGeradora']['codigo'] : '')); ?>
  </div>  
  
 <div class='form-actions'>
	 <?php echo $this->BForm->submit('Salvar', array('div' => false, 'class' => 'btn btn-primary')); ?>
	 <?= $html->link('Voltar', array('controller' => 'laboratorios', 'action' => 'index'), array('class' => 'btn')); ?>
</div>