...
<div class="row-fluid inline">
	<?php echo $this->BForm->input('codigo', array('class' => 'input-medium', 'label' => 'Código Epi', 'type' => 'text')) ?>
	<?php echo $this->BForm->input('nome', array('class' => 'input-xxlarge', 'label' => 'Descrição')) ?>  
	...
	<?php echo $this->BForm->input('EpiExterno.codigo_externo', array('class' => 'input-small', 'label' => 'Código Externo')); ?>
</div>