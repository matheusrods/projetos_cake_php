...
<li class="scoop-hasmenu">
    ...
    <ul class="scoop-submenu">
        <?php if ($this->BMenu->permiteMenu(array('controller'=>'clientes','action'=>'acoes_cadastradas'))) :?>
            <li class="">
                <a href="/portal/clientes/acoes_cadastradas">
                    <span class="scoop-micon"><i class="fas fa-chart"></i></span>
                    <span class="scoop-mtext">Ações Cadastradas</span>
                    <span class="scoop-mcaret"></span>
                </a>
            </li>
        <?php endif;?>
