    ...
    <ul class="scoop-submenu">
        ...
        <?php
            if ($permiteMenuCadastros > 0) {
                echo $this->element('menu_lateral/modulos_terceiros/plano_de_acao/sub_menus/cadastros_terceiros');
            }

            if ($permiteMenuOperacoes > 0) {
                echo $this->element('menu_lateral/modulos_terceiros/plano_de_acao/sub_menus/operacoes_terceiros');
            }
        ?>
    </ul>
</li>
