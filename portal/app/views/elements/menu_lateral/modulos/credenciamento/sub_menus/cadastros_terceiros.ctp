<!-- Sub menus Credenciamento cadastros terceiros-->
...
<li class="scoop-hasmenu">
    ...
    <ul class="scoop-submenu">
        <li class="">
            <a href="/portal/propostas_credenciamento/minha_proposta/visualizar">
                <span class="scoop-micon"><i class="fas fa-chart"></i></span>
                <span class="scoop-mtext">Minha proposta</span>
                <span class="scoop-mcaret"></span>
            </a>
        </li>
    </ul>
