    ...
    <ul class="scoop-submenu">
        ...
        <?php
            if ($permiteMenuCadastros > 0) {
                echo $this->element('menu_lateral/modulos/observador_ehs/sub_menus/cadastros_terceiros');
            }

            if ($permiteMenuConsultas > 0) {
                echo $this->element('menu_lateral/modulos/observador_ehs/sub_menus/operacoes_terceiros');
            }

            if ($permiteMenuOperacoes > 0) {
                echo $this->element('menu_lateral/modulos/observador_ehs/sub_menus/consultas_terceiros');
            }
        ?>
    </ul>
</li>
