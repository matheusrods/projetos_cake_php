<div class="row-fluid inline">
    ...
    <?php if ($this->action == 'incluir_por_seguradora'): ?>
    ...
    <?php endif ?> 
	<?php echo $this->BForm->input('codigo_uperfil', array('empty' => 'Selecione ' , 'class' => 'input-medium', 'label' => 'Perfil', 'options' => $perfis, 'default' => 21)) ?>   
</div>
<div class="row-fluid inline">
