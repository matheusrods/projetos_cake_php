...
<div class="row-fluid inline">
	<?php echo $this->BForm->input('codigo', array('class' => 'input-medium', 'label' => 'Código Grupo Risco', 'type' => 'text')) ?>
	...
	<?php echo $this->BForm->input('RiscoAtributoDetalheExterno.codigo_externo', array('class' => 'input-small', 'label' => 'Código Externo')); ?>
</div>