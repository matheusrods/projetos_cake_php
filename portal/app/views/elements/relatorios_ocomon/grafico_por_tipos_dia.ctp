<div id="TipoPorDiaGraph" style="width:98%;height:450px;float:left"></div>
<?php 



if(isset($TipoPorDiaGraph['eixo_x']))
{

  echo $this->Javascript->codeBlock($this->Highcharts->render($TipoPorDiaGraph['eixo_x'], $TipoPorDiaGraph['series'], array(
      'renderTo' => 'TipoPorDiaGraph',
     ...
     // ),
      ...
      'title' => 'Entregas no Período por Tipo',
      'plotOptions' => array(         
          'series' => array(
              //'stacking' => 'normal'
          )
