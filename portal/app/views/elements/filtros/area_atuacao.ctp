<div class='well'>
    <div id='filtros'>
        <?php echo $bajax->form('AreaAtuacao', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'AreaAtuacao', 'element_name' => 'area_atuacao'), 'divupdate' => '.form-procurar')) ?>
        ...
        <div class="row-fluid inline">
            ...
            if ($is_admin) {
                if ($this->Buonny->seUsuarioForMulticliente()) {
                    ...
                    echo $this->Buonny->input_codigo_cliente2($this, array('input_name' => 'codigo_cliente', 'label' => 'Código (*)', 'name_display' => array('label' => 'Cliente'), 'checklogin' => false), 'AreaAtuacao');
                }
            } else {
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:AreaAtuacao/element_name:area_atuacao/" + Math.random())
        });
