<div class='well'>
	...
	<div id='filtros'>
		<?php echo $bajax->form('Exame', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Exame', 'element_name' => 'posicao_exames_sintetico'), 'divupdate' => '.form-procurar')) ?>
		
		<?php echo $this->element('exames/posicao_fields_filtros'); ?>
		...
		<div class="row-fluid">
		    ...
		    <?php // echo $this->Form->input('tipo_exame', array('required' => true, 'legend' => false, 'type' => 'select', 'multiple' => 'checkbox','label' => false, 'options' => $tipos_exames)); ?>
		    </div> -->
		    ...
		    <div class="span4 ">
				...
				<?php echo $this->BForm->input('agrupamento', array('type' => 'radio', 'options' => $tipos_agrupamento, 'default' => 1, 'legend' => false, 'label' => array('class' => 'radio input-medium'))) ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
		...
		bloquearDiv(div);
		div.load(baseUrl + "exames/posicao_exames_sintetico_listagem/" + Math.random());
		...
		jQuery("#limpar-filtro-posicao").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:Exame/element_name:posicao_exames_sintetico/" + Math.random())
        });
		...
		$("#ExameSituacaoVencerEntre").change(function(event) {
	     ...
	     //validação para habilitar o campo período após post do formulário
