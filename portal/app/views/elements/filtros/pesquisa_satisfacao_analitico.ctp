<div class='well'>
    <div id='filtros'>
        <?php echo $this->Bajax->form('PesquisaSatisfacao', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'PesquisaSatisfacao', 'element_name' => 'pesquisa_satisfacao_analitico'), 'divupdate' => '.form-procurar')) ?>
            <div class="row-fluid inline">                
                ...
                <?php if($gestor_logado == FALSE): ?>
                    <?php echo $this->BForm->input('codigo_gestor', array('label' => 'Gestor Comercial', 'class' => 'input-medium', 'options' => $gestores_com, 'empty' => 'Selecione')); ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        bloquearDiv(div);
        div.load(baseUrl + "pesquisas_satisfacao/listagem_pesquisa_satisfacao_analitico/" + Math.random());
        jQuery("#limpar-filtro").click(function(){
            bloquearDiv(jQuery(".form-procurar"));
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:PesquisaSatisfacao/element_name:pesquisa_satisfacao_analitico/" + Math.random())
            jQuery(".lista").empty();           
        });  
