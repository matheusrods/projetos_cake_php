<div class='well'>
  <div id='filtros'>
    <?php echo $bajax->form('Cid', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Cid', 'element_name' => 'cid'), 'divupdate' => '.form-procurar')) ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:Cid/element_name:cid/" + Math.random())
        });
