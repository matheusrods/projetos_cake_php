<div>
    <?php echo $bajax->form('Usuario', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Usuario', 'element_name' => 'buscar_usuario_cliente'), 'divupdate' => '.form-procurar-user')) ?>
...
<script>
    ...
    $(function(){
        ...
        console.log("Estou dentro dos filtros2: ",codigo_cliente)
        ...
        $("#limpar-filtro-usuario").on("click", function(){
            ...
            $(".form-procurar-user").load(baseUrl + "/filtros/limpar/model:Usuario/element_name:buscar_usuario_cliente/"+codigo_cliente+"/" + Math.random())
        })
    })
    ...
    function atualizaLista(codigo_cliente) {
        ...
        bloquearDiv(div);
        div.load(baseUrl + "usuarios/buscar_listagem_usuario_cliente/" + codigo_cliente + "/" + Math.random());
    }
</script>
