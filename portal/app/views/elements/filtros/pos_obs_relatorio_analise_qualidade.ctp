<div class='well'>
    <div id='filtros'>
        <?php echo $bajax->form('PosObsObservacoes', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'PosObsObservacoes', 'element_name' => 'pos_obs_relatorio_analise_qualidade'), 'divupdate' => '.form-procurar')) ?>
...
<?= $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:PosObsObservacoes/element_name:pos_obs_relatorio_analise_qualidade/" + Math.random())
        });
