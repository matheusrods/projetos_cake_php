<div class='well'>
	<?php echo $bajax->form('PedidoExame', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'PedidoExame', 'element_name' => 'resultado_exames'), 'divupdate' => '.form-procurar')) ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
		...
		bloquearDiv(div);
		div.load(baseUrl + "consulta_pedidos_exames/resultado_exames_listagem/" + Math.random());

		jQuery("#limpar-filtro-consulta-pedido-exame").click(function(){
            bloquearDiv(jQuery(".form-procurar"));
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:PedidoExame/element_name:resultado_exames/" + Math.random());
