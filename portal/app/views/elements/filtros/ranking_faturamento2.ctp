<?php if(isset($authUsuario['Usuario']['codigo_seguradora']) && $authUsuario['Usuario']['codigo_seguradora']): ?>
    <div class='well'>
        <strong>Seguradora: </strong> <?php echo $this->data['Notaite']['descricao_seguradora']; ?>
    </div>
<?php endif; ?>
<?php if(isset($authUsuario['Usuario']['codigo_corretora']) && $authUsuario['Usuario']['codigo_corretora']): ?>
    <div class='well'>
        <strong>Corretora: </strong> <?php echo $this->data['Notaite']['descricao_corretora']; ?>
    </div>
<?php endif; ?>
<?php if(isset($authUsuario['Usuario']['codigo_filial']) && $authUsuario['Usuario']['codigo_filial']): ?>
    <div class='well'>
        <strong>Filial: </strong> <?php echo $this->data['Notaite']['descricao_filial']; ?>
    </div>
<?php endif; ?>
<div class='well'>
	...
	<?php echo $this->element('itens_notas_fiscais/fields_filtros', array('mes_ano' => true, 'grupo_empresas' => in_array($this->data['Notaite']['agrupamento'], array(Notaite::AGRP_CLIENTES, Notaite::AGRP_PRODUTOS)) )); ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
		...
		bloquearDiv(div);
		div.load(baseUrl + "itens_notas_fiscais/ranking_faturamento_listagem/" + Math.random());
    });', false);
?>