...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        bloquearDiv(div);
        div.load(baseUrl + "propostas_credenciamento/listagem/" + Math.random());
        jQuery("#limpar-filtro").click(function(){
            bloquearDiv(jQuery(".form-procurar"));
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:PropostaCredenciamento/element_name:propostas_credenciamento/" + Math.random())
        });
    });', false);
?>