<div class='well'>
	...
	<div id='filtros'>
		...
		<?php echo $bajax->form('PedidoExame', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'PedidoExame', 'element_name' => 'resultado_de_exames'), 'divupdate' => '.form-procurar')) ?>
		
		<?= $this->element('consulta_pedidos_exames/fields_filtros2') ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
		...
		bloquearDiv(div);
		div.load(baseUrl + "consulta_pedidos_exames/resultado_de_exames_listagem/" + Math.random());
		...
		jQuery("#limpar-filtro-consulta-pedido-exame").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:PedidoExame/element_name:resultado_de_exames/" + Math.random());
