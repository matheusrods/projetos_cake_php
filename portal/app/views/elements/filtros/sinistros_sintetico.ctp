...
<div class='well'>
    ...
    <div id='filtros'>
        ...
        <?php echo $bajax->form('Sinistro', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Sinistro', 'element_name' => 'sinistros_sintetico'), 'divupdate' => '.form-procurar')) ?>
        ...
        <div class="row-fluid inline">
            ...
            <div id='agrupamento'>
                <?php echo $this->BForm->input('agrupamento', array('type' => 'radio', 'options' => $agrupamento, 'default' => 5, 'legend' => false, 'label' => array('class' => 'radio inline input-small'))) ?>
            </div>
        </div>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function() {
        setup_mascaras();
        atualizaListaSinteticoSinistros();
        
        jQuery("#limpar-filtro").click(function(){
            bloquearDiv(jQuery(".form-procurar"));
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:Sinistro/element_name:sinistros_sintetico/" + Math.random())
        });  
