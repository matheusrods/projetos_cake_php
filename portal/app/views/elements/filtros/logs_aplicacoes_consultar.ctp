<div class='well'>
	<?php echo $this->Bajax->form('LogAplicacao', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'LogAplicacao', 'element_name' => 'logs_aplicacoes_consultar'), 'divupdate' => '.form-procurar')) ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){ 
    	$(".hora").mask("99:99");
    	atualizaListaLogsAplicacoes();    	
    	setup_mascaras();
        
        jQuery("#limpar-filtro").click(function(){
            bloquearDiv(jQuery(".form-procurar"));
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:LogAplicacao/element_name:logs_aplicacoes_consultar/" + Math.random())
        });
    });', false);
