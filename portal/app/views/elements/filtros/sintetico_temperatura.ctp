<div class='well'>
    ...
    <div id='filtros'>
	    <?php echo $this->Bajax->form('RelatorioSm', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'RelatorioSm', 'element_name' => 'sintetico_temperatura'), 'divupdate' => '.form-procurar')) ?>
			...
			<div class="row-fluid inline">
				<div id="div-tipo-alvo">
					<?= $this->Buonny->input_alvos_bandeiras_regioes($this, array_merge($alvos_bandeiras_regioes, array('div' => '#div-tipo-alvo', 'force_model' => 'RelatorioSm', 'input_codigo_cliente' => 'codigo_cliente', 'exibe_label' => false, 'exibe_classes' => false, 'exibe_veiculo' => false, 'exibe_transportador' => true)))?>
				</div>
...
<?php if(!empty($filtrado)): ?>
	<?php echo $this->Javascript->codeBlock('
		jQuery(document).ready(function(){ 
			...
			bloquearDiv(div);
			div.load(baseUrl + "relatorios_sm/sintetico_temperatura_listagem/" + Math.random());
		});', false); 
	?>
<?php endif; ?>
<?php echo $this->Javascript->codeBlock('
    ...
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:RelatorioSm/element_name:sintetico_temperatura/" + Math.random())
            jQuery(".lista").empty();
        });
