<div class='well'>
    <?php echo $bajax->form('AgendamentoExame', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'AgendamentoExame', 'element_name' => 'consultas_agendas2'), 'divupdate' => '.form-procurar')) ?>
    ...
    <div class="row-fluid inline">
        ...
        <?php echo $this->BForm->input('com_anexo_aso', array('options' => $com_anexo_aso, 'empty' => 'Todos', 'class' => 'input-medium',  'label' => 'Com Anexo Exames')); ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:AgendamentoExame/element_name:consultas_agendas2/" + Math.random())
        });
