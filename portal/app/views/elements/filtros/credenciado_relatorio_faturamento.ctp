...
<div class='well'>
  <?php echo $bajax->form('Credenciado', 
    ...
    <div class="row-fluid inline">			
    <?php echo $this->BForm->input('status_auditoria', array('label' => 'Status Auditoria', 'class' => 'input-small', 'options' => $status_auditoria, 'empty' => 'Todos', 'default' => 'Liberados para Pagamento')); ?>
      <?php 			
