<div class='well'>
    ...
    <div id='filtros'>
        <?php echo $bajax->form('AtendimentoSac', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'AtendimentoSac', 'element_name' => 'atendimentos_sac_analitico'), 'divupdate' => '.form-procurar')) ?>
...
jQuery(document).ready(function(){
    ...
    '.(isset($filtrado) && ($filtrado) ? 'var div = jQuery("div.lista");bloquearDiv(div);div.load(baseUrl + "atendimentos_sacs/analitico_listagem/" + Math.random());':'').'
    jQuery("#limpar-filtro-atendimentos").click(function(){
        bloquearDiv(jQuery(".form-procurar"));
        jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:AtendimentoSac/element_name:atendimentos_sac_analitico/" + Math.random())
    });
