<div class="well">
  <?php echo $bajax->form('FichaStatusCriterio', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'FichaStatusCriterio', 'element_name' => 'resultados_pesquisa'), 'divupdate' => '.form-procurar')) ?>
...
<?php echo $this->Javascript->codeBlock('
    ...
    $("#limpar-filtro").click(function(){
			...
			$(".form-procurar").load(baseUrl + "/filtros/limpar/model:FichaStatusCriterio/element_name:resultados_pesquisa/" + Math.random())
		});
	});', false);?>