...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:GrupoHomogeneoExame/element_name:grupos_homogeneos_exames/codigo_cliente:'.$codigo_cliente.'/referencia:'.$referencia.'/" + Math.random())
        });
