<div class='well'>
  <div id='filtros'>
    <?php echo $bajax->form('Especialidade', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Especialidade', 'element_name' => 'especialidades'), 'divupdate' => '.form-procurar')) ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:Especialidade/element_name:especialidades/" + Math.random())
        });
