...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){            
            ...
            jQuery(".form-procurar").load(baseUrl + "filtros/limpar/model:GrupoEconomico/element_name:retira_permissao/codigo_questionario:" + "'.$codigo_questionario.'" + "/" + Math.random())
        ...
        function atualizaLista(codigo_questionario){ //console.log(codigo_questionario);
            ...
            //if($("#GrupoEconomicoCodigoCliente").val() != "") {
                ...
                bloquearDiv(div);
                div.load(baseUrl + "questionarios/listagem_retira_permissoes/" + codigo_questionario + "/" + Math.random());
            //}
        }
    });', false);
?>