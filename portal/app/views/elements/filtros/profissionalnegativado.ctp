<div class='well'>
    ...
    <div id='filtros'>
    	<?php echo $bajax->form('ProfissionalNegativacao', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'ProfissionalNegativacao', 'element_name' => 'profissionalnegativado'), 'divupdate' => '.form-procurar')) ?>
        <div class="row-fluid inline">
            <?php echo $this->BForm->input('cpf', array('class'=>'input-medium' ,'label'=>'CPF')) ?>
            <?php echo $this->BForm->input('nomedoprofissional', array('class' => 'input-xlarge', 'label'=>'Nome do Profissional')) ?>
