<div class='well'>
    <div id='filtros'>
        <?php echo $bajax->form('RiscosTipo', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'RiscosTipo', 'element_name' => 'riscos_tipo'), 'divupdate' => '.form-procurar')) ?>
        ...
        <div class="row-fluid inline">
            <?php echo $this->BForm->input('codigo', array('class' => 'input-small just-number', 'placeholder' => 'Código', 'label' => 'Código risco tipo', 'type' => 'text')) ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:RiscosTipo/element_name:riscos_tipo/" + Math.random())
        });
