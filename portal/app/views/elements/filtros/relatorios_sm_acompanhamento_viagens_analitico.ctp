<div class='well'>
    ...
    <div id='filtros'>
	    <?php echo $this->Bajax->form('RelatorioSm', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'RelatorioSm', 'element_name' => 'relatorios_sm_acompanhamento_viagens_analitico'), 'divupdate' => '.form-procurar')) ?>
			...
			<div class="row-fluid inline">
				<?php echo $this->BForm->input('vrot_codigo', array('label' => 'Rota', 'empty' => 'Todos','class' => 'input-medium', 'options' => array(1 => 'Possui rota',2=> 'Não possui rota'))) ?>
...
<?php if(!empty($filtrado)): ?>
	<?php echo $this->Javascript->codeBlock('jQuery(document).ready(function(){ atualizaListaRelatorioSmAcompanhamentoViagensAnalitico(); });', false); ?>
<?php endif; ?>
...
<?php echo $this->Javascript->codeBlock('
    ...
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:RelatorioSm/element_name:relatorios_sm_acompanhamento_viagens_analitico/" + Math.random())
            jQuery(".lista").empty();
        });  
