<div class='well'>
    ...
    <div id='filtros'>
	    <?php echo $this->Bajax->form('RelatorioSm', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'RelatorioSm', 'element_name' => 'relatorios_sm_custos_do_trajeto_analitico'), 'divupdate' => '.form-procurar')) ?>
...
<?php if(!empty($filtrado)): ?>
	<?php echo $this->Javascript->codeBlock('jQuery(document).ready(function(){ atualizaListaRelatorioSmCustosDasViagensAnalitico(); });', false); ?>
<?php endif; ?>
...
<?php echo $this->Javascript->codeBlock('
    ...
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:RelatorioSm/element_name:relatorios_sm_custos_do_trajeto_analitico/" + Math.random())
            jQuery(".lista").empty();
        });  
