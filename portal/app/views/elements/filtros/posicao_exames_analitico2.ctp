<div class='well'>
	...
	<div id='filtros'>
		<?php echo $bajax->form('Exame', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Exame', 'element_name' => 'posicao_exames_analitico2'), 'divupdate' => '.form-procurar')) ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
		...
		var codigo_cliente = $("#ExameCodigoCliente").val();//codigo cliente		

		if(codigo_cliente != ""){//se o codigo_cliente estiver vazio nao atualiza a lista
    		atualizaLista();
		}
        ...
        function atualizaLista() {
			...
			bloquearDiv(div);
			div.load(baseUrl + "exames/posicao_exames_analitico_listagem2/" + Math.random());
        }
		...
		jQuery("#limpar-filtro-posicao").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:Exame/element_name:posicao_exames_analitico2/" + Math.random())
        });
