...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#filtrar").click(function(){     
            bloquearDiv(div);
            div.load(baseUrl + "fichas_scorecard/log_faturamento_listagem/" + Math.random());
        });
        jQuery("#limpar-filtro").click(function(){
            bloquearDiv(jQuery(".form"));
            jQuery(".form").load(baseUrl + "/filtros/limpar/model:FichaScorecard/element_name:log_faturamento_filtros/" + Math.random())
        });
    });', false);
