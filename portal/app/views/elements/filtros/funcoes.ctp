<div class='well'>
  <div id='filtros'>
    <?php echo $bajax->form('Funcao', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Funcao', 'element_name' => 'funcoes'), 'divupdate' => '.form-procurar')) ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:Funcao/element_name:funcoes/" + Math.random())
        });
