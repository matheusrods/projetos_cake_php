<div class='well'>
    <?php echo $bajax->form('NotaFiscalServico', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'NotaFiscalServico', 'element_name' => 'demonstrativo_contas_medicas'), 'divupdate' => '.form-procurar')) ?>
        ...
        <div class="row-fluid inline"> 
            ...
            <?php echo $this->BForm->input('status_pagamento', array('label' => 'Status', 'class' => 'input-small', 'default' => '','options' => $status_pagamento)); ?>
...
<?php echo $this->Javascript->codeBlock('
    jQuery(document).ready(function(){
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:NotaFiscalServico/element_name:demonstrativo_contas_medicas/" + Math.random())
        });
        ...
        function atualizaListaNotaFiscalServico() {
            ...
            if($("#NotaFiscalServicoCodigoFornecedor").val() != "") {
                ...
                bloquearDiv(div);
                div.load(baseUrl + "notas_fiscais_servico/demonstrativo_contas_medicas_listagem/"+ Math.random());
            }
        }
