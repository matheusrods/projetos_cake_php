<div class='well'>
  <div id='filtros'>
    <?php echo $bajax->form('AnexoDigitalizacao', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'AnexoDigitalizacao', 'element_name' => 'digitalizacao_consulta_terceiros'), 'divupdate' => '.form-procurar')) ?>

      <?php echo $this->element('tipo_digitalizacao/fields_filtros_digitalizacao_consulta_terceiros') ?>
    ...
    jQuery(document).ready(function(){
        ...
        function atualizaListaDigitalizacao(){
            ...
            if($("#AnexoDigitalizacaoCodigoCliente").val() != "") {
                ...
                bloquearDiv(div);
                div.load(baseUrl + "tipo_digitalizacao/lista_digitalizacao_consulta_terceiros/" + Math.random());
            }
        }
