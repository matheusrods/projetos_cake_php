...
<div class='well'>
    ...
    <div id='filtros'>
        <?php echo $bajax->form('Proposta', array('autocomplete' => 'off', 'url' => array('controller' => 'filtros', 'action' => 'filtrar', 'model' => 'Proposta', 'element_name' => 'propostas_pendentes'.($status_tela==StatusProposta::EM_APROVACAO_GERENCIA ? '_gerencia':'')), 'divupdate' => '.form-procurar')) ?>
        ...
        -->
        <div class='row-fluid inline'>
            <?php echo $this->BForm->submit('Buscar', array('div' => false, 'class' => 'btn', 'id'=>'btnBuscar')); ?>
...
<?php echo $this->Javascript->codeBlock('
    ...
    $(document).ready(function(){
        ...
        '.(isset($filtrado) && ($filtrado) ? 'var div = jQuery("div.lista");bloquearDiv(div);div.load(baseUrl + "propostas/consulta_pendentes'.($status_tela==StatusProposta::EM_APROVACAO_GERENCIA ? '_gerencia':'').'_listagem/" + Math.random());':'').'
        ...
        jQuery("#limpar-filtro").click(function(){
            ...
            jQuery(".form-procurar").load(baseUrl + "/filtros/limpar/model:Proposta/element_name:propostas_pendentes'.($status_tela==StatusProposta::EM_APROVACAO_GERENCIA ? '_gerencia':'').'/" + Math.random())
