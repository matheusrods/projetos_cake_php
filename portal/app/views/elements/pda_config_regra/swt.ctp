...
?>
    ...
    <div class='row-fluid inline condicoes' >
        ...
        <div class="pull-right">
            <a id="cad_condicao" href="javascript:void(0);" class="btn btn-primary" style="color: #fff;" onclick="cad_condicoes_swt(1);" >Cad. Condição</a>
        </div>
    </div>
    ...
    <div class="modal fade" id="modal_condicoes_swt" data-backdrop="static" style="width: 65%; left: 16%; top: 15%; margin: 0 auto;"></div>
    ...
    <div class='row-fluid inline email_push solicitar_analise gestor_responsavel' >
        ...
        <div class="email_push">
            ...
            <div class='row-fluid inline input_email_push_simples input_email_push_completos'>
                ...
                <div class="input_email_push_simples">
                    ...
                    foreach($tipos_envios AS $codigo_env => $env):
                        if (
                            $this->data['PdaConfigRegra']['codigo_pda_tema'] === 10
                            && array_search(intval($codigo_env), array(2, 5))
                        ) {
                            continue;
                        }
                    ?>
                ...
                <div class="input_email_push_completos">
                    ...
                    foreach ($tipos_envios_completos AS $codigo_env => $env):
                        if (
                            $this->data['PdaConfigRegra']['codigo_pda_tema'] === 10
                            && array_search(intval($codigo_env), array(2, 5)) !== false
                        ) {
                            continue;
                        }
                    ?>
            ...
            <div class='row-fluid inline '>
                <?php echo $this->BForm->input('mensagem', array('class' => 'input_email_push input', 'type'=>'textarea', 'rows'=>10, 'cols'=>50, 'label' => 'Mensagem:','disabled' => 'disabled')); ?>
            </div>
            <div class='row-fluid inline '>
...
jQuery(document).ready(function(){
    ...
    libera_tema = function(codigo_tema){
        ...
        switch(codigo_tema) {
            case "8": //notificacao participantes
                $(".email_push").show();
                $(".input_email_push").removeAttr("disabled");

                break;
            
            case "9": //Notifcar de acordo com a criticidade
    ...
    cad_condicoes_swt = function (mostra) {
        if(mostra) {
            ...
            bloquearDiv(div);
            div.load(baseUrl + "pda_config_regra/modal_condicoes_swt/" + codigo + "/"  + codigo_cliente + "/" + codigo_tema + "/" + Math.random());
    ...
    atualizaListaCondicoesSwt = function(){
        ...
        if($("#PosConfigRegraCodigo").val() != "") {
            ...
            bloquearDiv(div);
            div.load(baseUrl + "pda_config_regra/listagem_condicoes_swt/" + codigo + "/" + codigo_pda_tema + "/" + codigo_status + "/" + Math.random());
