  ...
  <div class='row-fluid inline'> 		
	<?php echo $this->BForm->input('tipo_servico', array('label' => 'Tipo de Serviço (*)', 'class' => 'input', 'default' => '','empty' => 'Tipo de Serviço', 'options' => array('E' => 'Exames Complementares', 'G' => 'Engenharia', 'C' => 'Consultorias e Palestras','S'=> 'Saúde'),  'disabled' => ($edit_mode)? 'disabled': false)); ?>
<?php if($edit_mode): ?>
