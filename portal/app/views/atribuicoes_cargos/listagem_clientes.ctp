    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php echo $html->link('', array('controller' => 'atribuicoes_cargos', 'action' => 'gerenciar', $dados['Cliente']['codigo']), array('class' => 'icon-wrench', 'title' => 'Gerenciar atribuições de cargos')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
