...
?>
<?php echo $bajax->form('PrincipalCliente', array('url' => array('controller' => 'informacoes_tecnicas', 'action' => 'adicionar_principal_cliente', $codigo_cliente),'type' => 'post') ) ?>

<?php echo $bajax->form('PrincipalCliente') ?>
