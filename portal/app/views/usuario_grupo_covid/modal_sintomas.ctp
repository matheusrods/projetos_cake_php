<div class="modal-dialog modal-sm" style="position: static;">
	<div class="modal-content" id="modal_data">
		<div class="modal-header" style="text-align: center;">
			<h3>Respostas Sintomas Diários Covid-19</h3>
		</div>
		...
		<div class="modal-body" style="min-height: 295px;max-height: 360px;">
			...
			<?php 
				...
				echo "Não existe respostas do sintomas diários.";
			}
			?>
		</div>
	    ...
	    <div class="modal-footer">
	    	<div class="right">
				<a href="javascript:void(0);"onclick="sintomas(<?php echo $cpf; ?>, 0);"class="btn btn-danger">FECHAR</a>				
			</div>
		</div>
	</div>
</div>
