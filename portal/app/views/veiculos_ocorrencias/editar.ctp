<?php echo $this->BForm->create('VeiculoOcorrencia', array('url' => array('controller' => 'veiculos_ocorrencias', 'action' => 'editar')));?>
    <div class='row-fluid inline parent'>        
        <?php echo $this->BForm->input('codigo',array('class' => 'input-small', 'label' => 'Código','readonly'=>true,'type' => 'text' ))?>
    ...
    <div class='row-fluid inline parent'>        
        ...
        <?php echo $this->BForm->input('VeiculoOcorrencia.data_ocorrencia',array('class' => 'input-small data','type'=>'text', 'label' => 'Data da Ocorrência')); ?> 
    </div>
