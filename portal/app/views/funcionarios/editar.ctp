<?php echo $this->BForm->create('Funcionario', array('url' => array('controller' => 'funcionarios', 'action' => 'editar', $this->data['Funcionario']['codigo'], $codigo_cliente, $referencia, $terceiros_implantacao), 'type' => 'post')); ?>
<?php echo $this->BForm->input('edit_mode', array('type' => 'hidden', 'value' => 1)); ?>
