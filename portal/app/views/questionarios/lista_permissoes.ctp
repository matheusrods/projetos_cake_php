<?php if(!empty($lista_clientes_grupo)): ?>
    ...
    <?php echo $this->BForm->create('ClienteQuestionarios', array('url' => array('controller' => 'questionarios','action' => 'salvar_permissoes/'.$codigo_questionario))); ?>
    
    <table class="table table-striped">
        <thead>
            <tr>
                <th class="form-small">Permitido</th>
