<?php echo $this->BForm->create('Questionario', array('type' => 'file', 'enctype' => 'multipart/form-data','url' => array('controller' => 'Questionarios', 'action' => 'incluir	'), 'divupdate' => '.form-procurar')); ?>
	...
	<div class="row">
		<div class="span9">
			...
			<div class="row">
				...
				<div class="span6">
					<div style="width:80%;height:80%; border:1px solid #ccc; padding:5px;">
					<?php echo $this->data['Questionario']['img_app']; ?>
