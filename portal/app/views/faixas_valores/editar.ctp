<?php echo $this->BForm->create('TCdfvCriterioFaixaValor', array('type' => 'post' ,'url' => array('controller' => 'faixas_valores','action' => 'editar')));?>
	<?php echo $this->BForm->hidden('cdfv_codigo') ?>
