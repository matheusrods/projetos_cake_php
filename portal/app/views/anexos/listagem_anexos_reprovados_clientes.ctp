...
<table class="table table-striped">
    ...
    <?php foreach($fornecedor as $forn) :?>
        <tr>
            <td class="input-mini"><?php echo $forn['codigo'] ?></td>
            <td><?php echo $forn['razao_social'] ?></td>
            <td><?php echo $forn['nome'] ?></td>
            <td><?php echo $buonny->documento($forn['codigo_documento']) ?></td>

            <td style="text-align: center">
                <?php echo $this->Html->link('', array('controller' => 'anexos', 'action' => 'anexos_reprovados', $forn['codigo']), array('class' => 'icon-cog', 'title' => 'Visualizar'));?>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
