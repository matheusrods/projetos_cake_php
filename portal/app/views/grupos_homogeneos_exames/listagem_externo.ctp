    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="input-large"><?php echo $dados['GrupoHomogeneoExterno']['codigo_externo'] ?></td>
                <td>    
                    ...
                    <?php echo $this->Html->link('', array('action' => 'editar_externo', $codigo_cliente, $dados['GrupoHomogeneoExame']['codigo'], $dados['GrupoHomogeneoExterno']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar Código Externo')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
...
echo $this->Javascript->codeBlock("
    ...
    bloquearDiv(div);
    div.load(baseUrl + 'grupos_homogeneos_exames/listagem_externo/' + Math.random());
}
