<?php echo $this->BForm->create('ClienteProdutoPagador', array('url' => array('controller' => 'clientes_produtos_pagadores','action' => 'atualizar')));?>
	<br>
	...
	<div class='row-fluid inline parent'>
		<?php echo $this->BForm->input('codigo_produto',array('class' => 'input-xlarge', 'options' => $produtos,  'empty' => 'Todos Produtos', 'label' => 'Produto')) ?>
	</div>
