	        ...
	        <tbody>
	            <?php foreach ($dados_exames as $key => $exame) : ?>
		            ...
		            <tr>
		                ...
		                <td class="input-medium" style="background: <?php echo $color; ?>; text-align: center;"><a href="javascript:void(0);" onclick="removeExame(<?php echo $key; ?>, <?php echo $codigo_cliente_funcionario; ?>, this); " class="icon-trash"></a></td>
		            </tr>		            
	        	<?php endforeach ?>
	    	</tbody>
	    </table>