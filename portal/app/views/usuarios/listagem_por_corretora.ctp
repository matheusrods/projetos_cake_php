<table class='table table-striped tablesorter'>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?= $html->link('', array('action' => 'editar_por_corretora', $usuario['Usuario']['codigo']), array('class' => 'icon-edit', 'title' => 'Editar', 'onclick' => 'return open_dialog(this, \'Editar Usuário\', 800)')) ?>
            </td>
        </tr>
        <?php endforeach; ?>        
    </tbody>
