<?php echo $this->BForm->create('AparelhoAudiometrico', array('url' => array('controller' => 'cliente_aparelho_audiometrico','action' => 'incluir', $codigo_cliente))); ?>
...
<?php $this->addScript($this->Buonny->link_js('cliente_aparelho_audiometrico.js')); ?>