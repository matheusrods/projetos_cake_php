                        ...
                        if(data){
                            if(data.cliente){
                                ...
                                if(data.TViagViagem.viag_comboio){
                                    sm.parent().addClass('error').append('<div class=\"help-block error-message\">SM já possui comboio <a href=\"/portal/viagens/editar_comboio/\" onclick=\"editar_comboio(this)\">Editar</a></div>');
                                }
                            }else{
                                placa.val('');
                                motorista.val('');
