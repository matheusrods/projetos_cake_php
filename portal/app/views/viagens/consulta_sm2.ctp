<?php if (!isset($this->data['QViagViagem'])): ?>
	<?php echo $this->BForm->create('QViagViagem', array('autocomplete' => 'off', 'url' => array('controller' => 'viagens', 'action' => 'consulta_sm2', $nova_janela))) ?>
...
<?php else:?>
	...
	<ul class="nav nav-tabs">
		...
		<li><a href="#iscas" data-toggle="tab">Iscas</a></li>
		<li><a href="#ocorrencias" data-toggle="tab">Ocorrencias</a></li>
		<li><a href="#rmas" data-toggle="tab">RMA´s</a></li>
		<?php if($comboio): ?>
	...
	<div class="tab-content">
	    		...
	    		<table class="table" >
	    			...
	    			<tbody>
	    				<?php foreach ($escolta['Equipes'] as $equipe): ?>
		    				<tr>
		    					<td><?php echo $equipe['QVescViagemEscolta']['vesc_equipe'] ?></td>
		    					<td><?php echo $equipe['QVescViagemEscolta']['vesc_telefone'] ?></td>
		    					<td><?php echo $equipe['QVtecVersaoTecnologia']['vtec_descricao']; ?></td>
								<td><?php echo $equipe['QVtecVersaoTecnologia']['vtec_versao']; ?></td>
								<td><?php echo $equipe['QVescViagemEscolta']['vesc_numero_terminal']; ?></td>
		    					<td><?php echo strtoupper($equipe['QVescViagemEscolta']['vesc_placa']) ?></td>
		    					<td><?php echo ($equipe['QVescViagemEscolta']['vesc_armada']) ? 'Sim' : 'Não' ?></td>
		    					<td><?php echo ($equipe['QVescViagemEscolta']['vesc_velada']) ? 'Sim' : 'Não' ?></td>
		    				</tr>
	    				<?php endforeach; ?>
	    			</tbody>
	 ...
	 <!--    <div class="tab-pane vertical-scroll" id="rota" style="min-height:530px;max-height:550px;overflow-y:auto;">
			<?php //if(!empty($this->data['TRotaRota']['rota_codigo'])): ?>
				<div style="float:left;width:450px;">
					...
					<?php //foreach($this->data['TRotaRota']['itinerario'] as $key => $destino): ?>
						<div class="row-fluid inline">
							<?php //echo $this->BForm->input('TRotaRota.itinerario.'.$key, array('label' => false, 'readonly' => true, 'class' => 'input-xlarge', 'type' => 'text')); ?>
						</div>
					<?php //endforeach; ?>
					<div class="row-fluid inline">
				...
				<div id="mapa" style="float:left;width:525px;height:525px;">
					<iframe id="canvas-mapa" src="/portal/rotas/mapa/<?php //echo $this->data['TRotaRota']['refe_codigos'] ?>" width="100%" height="100%" style="border:none;margin:0px;padding:0px;"></iframe>
				</div>
			<?php //else: ?>
		    	<div class="row-fluid inline">
					<h5>Rota</h5>
 ...
 -->
	    ...
	    <div class="tab-pane" id="eventos">
	    	<div id="evento-list" >
	    		<?php echo $this->element('viagens/lista_eventos_viagem'); ?>
	    	</div>	    	
	    </div>		        
		<? endif; ?>
		-->
