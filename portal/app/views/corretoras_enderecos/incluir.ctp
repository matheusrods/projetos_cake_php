<?php
    if($session->read('Message.flash.params.type') == MSGT_SUCCESS){
        ...
        echo $javascript->codeBlock("close_dialog();carrega_endereco_corretora('{$this->passedArgs[0]}')");
        exit;
    }
?>
<?php echo $bajax->form('CorretoraEndereco', array('url' => array('action' => 'incluir', $this->passedArgs[0]))); ?>
