<?php
    if($session->read('Message.flash.params.type') == MSGT_SUCCESS){
        ...
        echo $javascript->codeBlock("close_dialog(); carrega_contatos_funcionario(".$this->passedArgs[0].")");
        exit;
    }
?>
<?php echo $this->Bajax->form('FuncionarioContato',array('url' => array('controller' => 'funcionarios_contatos', 'action' => 'incluir', $this->passedArgs[0]))) ?>
<div class="row-fluid inline">
    <?php echo $this->BForm->hidden('0.codigo') ?>
    <?php echo $this->BForm->hidden('0.codigo_funcionario') ?>
...
<div id="retornos">
    ...
    <?php if (isset($this->data['FuncionarioContato'])): ?>
        <?php for ($indice = 1; $indice < count($this->data['FuncionarioContato']); $indice++): ?>
            <div class="row-fluid inline">
