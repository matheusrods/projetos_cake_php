...
<?php if(!isset($dados_arquivo)): ?>
	...
	<?php echo $this->BForm->create('Importar', array('type' => 'file', 'enctype' => 'multipart/form-data','url' => array('controller' => 'importar', 'action' => 'importar_usuario', $codigo_cliente), 'onSubmit' => '$("#carregando").show();')); ?>
	<div class="well">
		<div class='row-fluid inline'>
			<?php echo $html->link('Modelo para Importação', '/files/modelos/arquivo_importacao_usuario.xls', array('class' => 'btn btn-success', 'escape' => false, 'target' => '_blank',  'title' => 'Visualizar Modelo para Importação', 'style' => 'float:right; margin-right: 50px; color:#FFF'));?>
		</div>
		<div class='row-fluid inline'>
		 ...
		 <div id="retorno">
		    ...
		    <tbody>
	            ...
	            <tr>
	            	...
	            	<td style="font-weight: bold;" class="input-medium"><?php echo (!empty($dados_arquivo['nome_arquivo_sucesso']))? $html->link('Abrir Arquivo', array('controller'=>'importar','action' => 'abre_arquivo',$dados_arquivo['nome_arquivo_sucesso'], 'importacao_dados_usuario'), array('class' => 'btn btn-success', 'style' => 'color:#FFF')) : '' ;?></td>
	            </tr>
	            <tr>
	            	...
	            	<td style="font-weight: bold;" class="input-medium"><?php echo (!empty($dados_arquivo['nome_arquivo_erro']))? $html->link('Abrir Arquivo', array('controller'=>'importar','action' => 'abre_arquivo',$dados_arquivo['nome_arquivo_erro'], 'importacao_dados_usuario'), array('class' => 'btn btn-danger', 'style' => 'color:#FFF')) : '' ;?></td>
	            </tr>
		    </tbody>
		    <tfoot>
...
<div class='form-actions'>
	<?php echo $html->link('Nova Importação', array('controller' => 'importar', 'action' => 'importar_usuario', $codigo_cliente), array('class' => 'btn btn-primary')); ?>
	<?php echo $html->link('Voltar', array('controller' => 'usuarios', 'action' => 'por_cliente', $codigo_cliente), array('class' => 'btn')); ?>
</div>
