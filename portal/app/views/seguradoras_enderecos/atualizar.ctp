<?php 
    if($session->read('Message.flash.params.type') == MSGT_SUCCESS){
        ...
        echo $javascript->codeBlock("close_dialog();carrega_endereco_seguradora('{$codigo_seguradora}')");
        exit;
    }
?>
<?php echo $bajax->form('SeguradoraEndereco', array('url' => array('action' => 'atualizar', $this->passedArgs[0]))); ?>
