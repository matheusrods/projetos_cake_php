        ...
        <tbody>
            ...
            <tr>
                ...
                <td>    
                    ...
                    <?php echo $this->Html->link('', array('action' => 'editar_externo', $codigo_cliente, $dados['GrupoHomogeneo']['codigo'], $dados['GrupoHomogeneoExterno']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar Código Externo')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
