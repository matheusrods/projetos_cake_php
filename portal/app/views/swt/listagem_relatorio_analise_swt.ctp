    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th><?php echo 'ID Análise Walk & Talk' ?></th>
                ...
                <th><?php echo 'Qualidade do Walk & Talk' ?></th>
        ...
        <tbody>
            ...
            foreach ($dados_respondido as $dados): ?>
                <tr>
                    ...
                    <td>
                        <a href="#void" id="expandir_1" onclick="respostas_formulario(<?php echo $dados['PosSwtFormRespondido']['codigo'];?>,'1');" title='Dados Questionário Análise Qualidade Walk & Talk' >
                            <?php echo $dados['PosSwtFormRespondido']['codigo'] ?>&nbsp;<i id="icone" class="icon-search"></i>
                        </a>
                    </td>
                    <td>
                        <?php if(!empty($dados['PosSwtFormRespondido']['codigo_form_respondido_swt'])) : ?>
                            <a href="#void" id="expandir_1" onclick="respostas_formulario(<?php echo $dados['PosSwtFormRespondido']['codigo_form_respondido_swt'];?>,'1');" title='Dados Questionário Walk & Talk' >
                                <?php echo $dados['PosSwtFormRespondido']['codigo_form_respondido_swt'] ?>&nbsp;<i id="icone" class="icon-search"></i>
                            </a>
                        <?php endif;?>
                    </td>
                    ...
                    <td>
                        <?php if(!empty($dados['PosSwtFormRespondido']['codigo_form_respondido_swt'])) : ?>
                            <a href="#void" id="expandir_1" onclick="respostas_acoes_melhoria(<?php echo $dados['PosSwtFormRespondido']['codigo_form_respondido_swt'];?>,'1');" title='Dados Ações Melhoria Walk & Talk' ><i id="icone_1" class="icon-eye-open"></i></a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach ?>
...
<?php echo $this->Javascript->codeBlock('
    function atualizaLista(){
        ...
        bloquearDiv(div);
        div.load(baseUrl + "swt/listagem_relatorio_analise_swt/" + Math.random());
    }   
		...
		$("#export_swt").click(function(){
            ...
            function(isConfirm) {
                if (isConfirm) {
                    ...
                    var getUrl = baseUrl + "Swt/url_relatorio/analise_swt";
