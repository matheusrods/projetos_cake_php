...
?>
<?php echo $this->Bajax->form('FichaScorecardArtCriminal', array('url' => array('controller' => 'fichas_scorecard_art_criminais', 'action' => 'incluir', $this->passedArgs[0], $this->passedArgs[1]))); ?>
