    ...
    <tbody>
        <?php foreach($clientes as $cliente) :?>
            <tr>
                ...
                <?php echo $html->link('', array('controller' => 'exames', 'action' => 'vencimento_exames', $cliente['Cliente']['codigo']), array('class' => 'icon-file', 'data-toggle' => 'tooltip', 'title' => 'Gerar relatório de vencimento de exames')); ?>
                </td>
            </tr>
        <?php endforeach; ?>        
    </tbody>
