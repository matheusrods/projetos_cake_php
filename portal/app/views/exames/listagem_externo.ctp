    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="input-large"><?php echo $dados['ExameExterno']['codigo_externo'] ?></td>
                <td>    
                    ...
                    <?php echo $this->Html->link('', array('action' => 'editar_externo', $codigo_cliente, $dados['Exame']['codigo'], $dados['ExameExterno']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar Código Externo')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
