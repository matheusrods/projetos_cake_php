    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="input-large"><?php echo $dados['MotivoAfastamentoExterno']['codigo_externo'] ?></td>
                <td>    
                    ...
                    <?php echo $this->Html->link('', array('action' => 'editar_externo',  $codigo_cliente, $dados['MotivoAfastamento']['codigo'], $dados['MotivoAfastamentoExterno']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar Código Externo')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
...
echo $this->Javascript->codeBlock("
    ...
    function atualizaStatus(codigo, status){
        $.ajax({
            type: 'POST',
            url: baseUrl + 'riscos/atualiza_status/' + codigo + '/' + status + '/' + Math.random(),
            beforeSend: function(){
