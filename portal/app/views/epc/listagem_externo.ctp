        ...
        <tbody>
            ...
            <tr>
                ...
                <td>    
                    ...
                    <?php echo $this->Html->link('', array('action' => 'editar_externo', $codigo_cliente, $dados['Epc']['codigo'], $dados['EpcExterno']['codigo']), array('class' => 'icon-edit ', 'title' => 'Editar Código Externo')); ?>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
...
echo $this->Javascript->codeBlock("
    ...
    bloquearDiv(div);
    div.load(baseUrl + 'epc/listagem_externo/' + Math.random());
}
