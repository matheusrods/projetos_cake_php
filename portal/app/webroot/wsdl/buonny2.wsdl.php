...
<wsdl:definitions xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:soap11="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:wsp="http://www.w3.org/ns/ws-policy" xmlns:wsp200409="http://schemas.xmlsoap.org/ws/2004/09/policy" xmlns:wsp200607="http://www.w3.org/2006/07/ws-policy"
	...
	<wsdl:types xmlns:xsd="http://www.w3.org/2001/XMLSchema">
		<xsd:schema attributeFormDefault="unqualified" elementFormDefault="qualified">
			...
			<xsd:import schemaLocation="alterar_sm.request.xsd" namespace="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/wsdl/buonny"/>
			<xsd:import schemaLocation="alterar_sm.response.xsd" namespace="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/wsdl/buonny"/>
			...
			<xsd:import schemaLocation="atualizar_motorista.response.xsd" namespace="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/wsdl/buonny"/>
			<xsd:element type="xsd:string" name="cnpj_cliente"/>
			<xsd:element type="xsd:string" name="token"/>
			<xsd:element type="xsd:string" name="sm"/>
	...
	<wsdl:message name="AlterarSmRequestMessage">
		<wsdl:part xmlns:xsns="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/wsdl/buonny" name="requestViagem" element="xsns:alterar_sm"/>
	</wsdl:message>
	<wsdl:message name="AlterarSmResponseMessage">
		<wsdl:part xmlns:xsns="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/wsdl/buonny" name="responseViagemResult" element="xsns:alterar_sm_result"/>
	</wsdl:message>
	...
	<wsdl:message name="AtualizarMotoristaRequestMessage">
		<wsdl:part element="cnpj_cliente" name="cnpj_cliente"/>
		<wsdl:part element="token" name="token"/>
		<wsdl:part element="sm" name="sm"/>
		<wsdl:part element="cpf" name="cpf"/>
	</wsdl:message>
	<wsdl:message name="AtualizarMotoristaResponseMessage">
		<wsdl:part xmlns:xsns="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/wsdl/buonny" name="responseMotoristaResult" element="xsns:motorista_result"/>
	</wsdl:message>
	...
	<wsdl:portType name="AlterarSmPort">
		<wsdl:operation name="alterarSm">
			<wsdl:input name="alterarSmRequest" message="ns0:AlterarSmRequestMessage"/>
			<wsdl:output name="alterarSmResponse" message="ns0:AlterarSmResponseMessage"/>
		</wsdl:operation>
	</wsdl:portType>
	...
	<wsdl:portType name="AtualizarMotoristaPort">
		<wsdl:operation name="atualizarMotorista">
			<wsdl:input name="atualizarMotoristaRequest" message="ns0:AtualizarMotoristaRequestMessage"/>
			<wsdl:output name="atualizarMotoristaResponse" message="ns0:AtualizarMotoristaResponseMessage"/>
		</wsdl:operation>
	</wsdl:portType>
	...
	<wsdl:binding name="AlterarSmSOAP11Binding" type="ns0:AlterarSmPort">
		<soap11:binding transport="http://schemas.xmlsoap.org/soap/http" style="document"/>
		<wsdl:operation name="alterarSm">	
			<soap11:operation style="document" />
			<wsdl:input name="alterarSmRequest">
				<soap11:body parts="requestViagem" use="literal"/>
			</wsdl:input>
			<wsdl:output name="alterarSmResponse">
				<soap11:body parts="responseViagemResult" use="literal"/>
			</wsdl:output>
		</wsdl:operation>
	</wsdl:binding>
	...
	<wsdl:binding name="AtualizarMotoristaSOAP11Binding" type="ns0:AtualizarMotoristaPort">
		<soap11:binding transport="http://schemas.xmlsoap.org/soap/http" style="document"/>
		<wsdl:operation name="atualizarMotorista">	
			<soap11:operation style="document" />
			<wsdl:input name="atualizarMotoristaRequest" message="tns:AtualizarMotoristaRequestMessage"/>
			<wsdl:output name="atualizarMotoristaResponse">
				<soap11:body parts="responseMotoristaResult" use="literal"/>
			</wsdl:output>
		</wsdl:operation>
	</wsdl:binding>
	...
	<wsdl:service name="BuonnyService">
    	<wsdl:port name="IncluirSm" binding="ns0:IncluirSmSOAP11Binding">
			<soap11:address location="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/soap/buonny2_soap"/>
		</wsdl:port>
    	<wsdl:port name="AlterarSm" binding="ns0:AlterarSmSOAP11Binding">
			<soap11:address location="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/soap/buonny2_soap"/>
		</wsdl:port>		
		...
		<wsdl:port name="AtualizarMotorista" binding="ns0:AtualizarMotoristaSOAP11Binding">
			<soap11:address location="http://<?php echo $_SERVER['HTTP_HOST']; ?>/portal/soap/buonny2_soap"/>
		</wsdl:port>
	</wsdl:service>
</wsdl:definitions>