 ...
 * @license
 *
 * MultiselectMulti v2.3.2
 * http://crlcu.github.io/multiselectMulti/
 *
 * Copyright (c) 2016 Adrian Crisan
 * Licensed under the MIT license (https://github.com/crlcu/multiselectMulti/blob/master/LICENSE)
 */

if (typeof jQuery === 'undefined') {
    throw new Error('multiselectMulti requires jQuery');
}
...
;(function ($) {
    ...
    if (version[0] < 2 && version[1] < 7) {
        throw new Error('multiselectMulti requires jQuery version 1.7 or higher');
    }
})(jQuery);
...
;(function (factory) {
    ...
    var MultiselectMulti = (function($) {
        /** MultiselectMulti object constructor
         *
         *  @class MultiselectMulti
         *  @constructor
        **/
        function MultiselectMulti( $select, settings ) {
    ...
    $.fn.multiselectMulti = function( options ) {
        return this.each(function() {
            var $this    = $(this),
                data     = $this.data('crlcu.multiselectMulti'),
                settings = $.extend({}, $.multiselectMulti.defaults, $this.data(), (typeof options === 'object' && options));

            if (!data) {
                $this.data('crlcu.multiselectMulti', (data = new MultiselectMulti($this, settings)));
            }
        });
    };
