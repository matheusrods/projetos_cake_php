...
//        var w = options.width - options.fixedColumnWidth;
        var w = $(mainid).width() - options.fixedColumnWidth - 25;
        //sanity check
    ...
    function buildFixedColumns(src, section, cols, target) {
        ...
        if ($(section, src).length) {
            var colHead = $("<table class='" + $(src).attr('class') + "'></table>").appendTo(target);
            ...
            $(section + " tr", src).each(function() {
                ...
                $(cellType + ":lt(" + cols + ")", this).each(function() {
                    $("<td class='" + $(this).attr('class') + "'>" + $(this).html() + "</td>").addClass(this.className).attr("id", this.id).appendTo(tr);
    ...
    function buildFixedTable(src, section, target) {
        if ($(section, src).length) {
            var th = $("<table class='" + $(src).attr('class') + "'></table>").appendTo(target);
            var tr = null;
            ...
            $(section + " tr", src).each(function() {
                ...
                $(cellType, this).each(function() {
                    $("<td class='" + $(this).attr('class') + "'>" + $(this).html() + "</td>").appendTo(tr);
                });
    ...
    function adjustSizes(options) {
        ...
        $("#" + Id + " ." + options.classColumn + " .fixedTable table tr").each(function(i) {
            $(this).mouseover(function() {
                ...
                obj.children("td").addClass(hoverclass);
                obj.children("td").children("pre").addClass(hoverclass);
            });
            $(this).mouseout(function() {
                $(this).children("td").removeClass(hoverclass);
                var obj = $("#" + Id + " .fixedContainer .fixedTable table tr").eq(i);
                obj.children("td").removeClass(hoverclass);
                obj.children("td").children("pre").removeClass(hoverclass);
            });
        });
        ...
        $("#" + Id + " .fixedContainer .fixedTable table tr").each(function(i) {
            $(this).mouseover(function() {
                $(this).children("td").addClass(hoverclass);
                $(this).children("td").children("pre").addClass(hoverclass);
            ...
            $(this).mouseout(function() {
                $(this).children("td").removeClass(hoverclass);
                $(this).children("td").children("pre").removeClass(hoverclass);
                var obj = $("#" + Id + " ." + options.classColumn + " .fixedTable table tr").eq(i);
                obj.children("td").removeClass(hoverclass);
            });
        });
