   ...
   public function credenciais() {             
        ...
        try {
            ...
            if (Ambiente::getServidor() == Ambiente::SERVIDOR_PRODUCAO) {
              $this->wsdlURL = 'http://jasperprd.ithealth.corp:8080/jasperserver/services/repository?wsdl';
            } else {
              $this->wsdlURL = 'http://jasperdev.ithealth.corp:8080/jasperserver/services/repository?wsdl';
            }
