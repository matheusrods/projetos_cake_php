...
#instr_header {
	background: url('http://rhhealth.com.br/assets/img/logo-rhhealth.png') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
do Sacado</b></div></TD></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="/portal/img/boleto/logobb.jpg"></td>
			<td width=50>
		...
		<tr class="campos">
			...
			<td class="valor_doc"><?php echo number_format($dadosboleto["valor_boleto"], 2, ',', '.') ?></td>
		</tr>
      </tbody>
      </table>
		...
		<tr class="campos">
			...
			<td class="valor_doc2"><?php echo number_format($dadosboleto["valor_boleto"], 2, ',', '.') ?></td>
		</tr>
		</tbody>
		</table>
