...
/*
 * FOI ALTERADO POR HENRIQUE SILVA EM 30/11/2012
 ...
 */
//$nossonumero = "00000".$dadosboleto["nosso_numero"];
if($dadosboleto["carteira"] == '101'){
  $dv_nosso_numero = modulo_11((formata_numero($dadosboleto["nosso_numero"],7,0)),9,0);
  $nossonumero = str_pad($dadosboleto["nosso_numero"],12,'0', STR_PAD_LEFT).$dv_nosso_numero;
}else
  $nossonumero = "00000".$dadosboleto["nosso_numero"];
