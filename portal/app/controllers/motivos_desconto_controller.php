<?php
class MotivosDescontoController extends AppController {

    public $name = 'MotivosDesconto';
    public $uses = array('MotivosDesconto');

    public function beforeFilter() {

        parent::beforeFilter();
       
        $this->_model = $this->MotivosDesconto;
        $this->_modelName = $this->_model->name;
        $this->_labelName = 'Motivos de Desconto';
        $this->_controllerName = 'motivos_desconto';
